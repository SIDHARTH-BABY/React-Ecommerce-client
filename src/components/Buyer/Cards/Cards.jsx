    ...
    <div>
      ...
      {/* <div className="flex flex-wrap bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% py-16 sm:py-24 lg:py-16 px-20"> */}
        ...
        >
          ...
          <h5 className="mb-2 mt-4 text-xl font-medium leading-tight text-neutral-800 text-white dark:text-neutral-50">
            Card title
          </h5>
        ...
        <div
          className="block max-w-sm rounded-lg bg-white bg-cover p-6 shadow-lg dark:bg-neutral-700 ml-10 mt-10 mr-10"
          //   style=`background-image: url('...');
          //   style={{ backgroundImage: `url(${slides[1].url})` }}
        >
          {/* content image */}
